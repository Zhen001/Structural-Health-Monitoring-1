...
for loop_eigen=1:size(Eigen_Vector_A1,2)
    %
    System_Eigenvalue(1,loop_eigen)=(log(Eigen_Value_A1(loop_eigen,loop_eigen))+2*pi*loop_eigen*j)/sampling_step;
    System_Eigenvalue(1,size(Eigen_Vector_A1,2)+loop_eigen)=(log(Eigen_Value_A1(loop_eigen,loop_eigen))-2*pi*loop_eigen*j)/sampling_step;
